        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
                <th class="table-check"><input type="checkbox" /></th><th class="table-id">编号</th><th class="table-title">文章ID</th><th class="table-type">内容</th><th class="table-type">时间</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
              <?php
  ...
  $(function(){
    ...
    $('#btn-delete-selected').on('click', function(){
      if(confirm('是否确定删除该记录，可以在回收站中恢复.')) {
        ...
        $.get('admin/delete_selected_comment', {commIdStr: delStr}, function (data) {
          if (data == 'success') {
